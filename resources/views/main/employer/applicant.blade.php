                    ...
                    <div class="col-xl-9 col-lg-9 col-md-8">
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-md-12">
                                    <h4>Applicants List For Your Vacancy</h4>                       
                                    <div class="row mb-3">
                                        <div class="col-md-12">
    ...
    $(function () {
        var table = $('.data-table').DataTable({
            ...
            columns: [
                ...
                {data: 'email_applicant', name: 'email_applicant'},
            ...
            columnDefs: [{
                ...
                return '<a class="genric-btn info small" href="/uploaded_resume/'+data+'"><i class="fas fa-download"></i> Download</a>';
                }
            }],
            lengthMenu: [
                [ 10, 25, 50, -1 ],
