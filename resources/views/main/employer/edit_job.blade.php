                    ...
                    <div class="col-xl-9 col-lg-9 col-md-8">
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                ...
                                <form action="{{ route('add-jobs.update', $job->id) }}" method="post">
                                @csrf
                                @method('PUT')
                                <h4>Edit Job Vacancy</h4>
                                    ...
                                    <div class="box-footer">
                                        <button type="submit" name="submit" class="form-control genric-btn success" title="Simpan Data">Edit Job</button>
                                    </div>
                                </form>    
                            </div>
                        </section>
